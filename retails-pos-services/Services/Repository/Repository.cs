...
namespace QSRRepositoryServices.Services.Repository
{
    public class Repository : IRepository
    {
        private readonly QSRDBContext _db;
        private readonly EmailHelper _emailHelper;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IServiceScopeFactory _scopeFactory;

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        public Repository(QSRDBContext db, EmailHelper emailHelper, IHttpContextAccessor httpContextAccessor, IServiceScopeFactory scopeFactory)
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        public async Task SimulatePaymentStatusUpdate(string transactionId)
        {
            ...
            {
                var db = scope.ServiceProvider.GetRequiredService<QSRDBContext>();
